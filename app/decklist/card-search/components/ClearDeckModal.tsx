      ...
      >
        ...
        <div className="px-6 py-4">
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            Are you sure you want to clear all cards from:
          </p>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
            This will remove all cards from both the main deck and reserve. The deck name and format will be preserved.
          </p>
        </div>
