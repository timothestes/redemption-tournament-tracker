...
export default function LoadDeckModal({ onLoadDeck, onClose }: LoadDeckModalProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent size="lg" className="max-w-2xl max-h-[80vh] flex flex-col">
        {/* Header */}
        <DialogHeader className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
        ...
        <div className="px-6 py-3 border-b border-gray-200 dark:border-gray-700">
          <input
            ...
            className="w-full px-4 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-ring text-gray-900 dark:text-white"
          />
        </div>
        ...
        {/* Footer */}
        <DialogFooter className="bg-gray-50 dark:bg-gray-900 justify-end">
          <button
            onClick={onClose}
