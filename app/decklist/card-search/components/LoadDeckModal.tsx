  ...
  return (
    <Dialog open={true} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent size="lg" className="max-w-2xl max-h-[80vh] flex flex-col">
        {/* Header */}
        <DialogHeader className="bg-primary/10 border-primary/30">
            ...
            <div className="space-y-2">
              {filteredDecks.map((deck) => (
                <button
                  ...
                  className="w-full text-left p-4 bg-muted/50 hover:bg-muted rounded-lg border border-border transition-colors group"
                >
