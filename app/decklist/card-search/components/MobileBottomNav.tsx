...
export function MobileBottomNav({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 inset-x-0 z-[70] bg-card border-t border-border flex items-center justify-around h-14 pb-[env(safe-area-inset-bottom)]">
